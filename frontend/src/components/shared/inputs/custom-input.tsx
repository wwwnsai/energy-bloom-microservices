          ...
          <div className="flex w-full flex-col">
            <FormControl>
              <Input
                ...
                className="text-[16px] placeholder:text-[16px] rounded-lg border border-gray-300 text-gray-100 placeholder:text-gray-500 bg-gray-25 focus:outline-none focus:ring-2 focus:ring-tertiary focus:border-transparent py-3 px-4 w-full"
